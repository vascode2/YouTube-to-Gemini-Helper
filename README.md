...
**Last updated:** `2026-07-03T05:59:12Z`

**Recent commits (last 5 on HEAD):**

- `c7f86f8` feat(mac): restore live v15 config + add toast-dwell (v16) _(30 hours ago)_
- `fe14906` fix(gemini+toast): dark-theme composer scan, faster paste, single home-page bubble _(7 days ago)_
