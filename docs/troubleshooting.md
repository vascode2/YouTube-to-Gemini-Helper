...
**Last updated:** `2026-07-02T00:18:10Z`

**Recent commits (last 5 on HEAD):**

- `fe14906` fix(gemini+toast): dark-theme composer scan, faster paste, single home-page bubble _(6 days ago)_
- `9b35990` fix(gemini): robust, self-verifying composer insertion (v1.2.8) _(2 weeks ago)_
- `6fa4348` docs: document unfocused-Brave Alt+Z behaviour (Linux) _(3 weeks ago)_
- `2a82e67` fix(linux): make Alt+Z work when Brave is not the focused window _(3 weeks ago)_
- `371b379` docs(tests): document the full-system test in tests/e2e/README _(3 weeks ago)_
